    ...
    internal static class SuggestionFilterRegistry
    {
        ...
        private static readonly FunctionFilterDefinition[] FunctionFilters =
        {
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "engine", "engines", "propulsion", "motor", "thruster", "rocket" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "control", "rcs", "reaction", "sas", "probe", "gyro" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "fuel", "tank", "tanks", "lf", "oxidizer", "propellant", "fueltank" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "aero", "aerodynamic", "aerodynamics", "wing", "wings", "fairing", "lifting" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "pod", "pods", "command", "cockpit", "hab", "crew", "capsule" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "electrical", "battery", "solar", "rtg", "power" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "science", "experiment", "lab", "sensor", "sensors" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "utility", "ladder", "light" },
            ...
            new FunctionFilterDefinition
            {
                ...
                // heat prefix → "he" suggests Thermal (related name ≠ typed text).
                SearchTerms = new[] { "thermal", "radiator", "heat", "cooling", "heatsink" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "communication", "communications", "comm", "antenna", "relay" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "coupling", "coupler", "docking", "decoupler", "dock" },
            ...
            new FunctionFilterDefinition
            {
                ...
                SearchTerms = new[] { "ground", "landing", "leg", "legs", "wheel", "wheels" },
